...
// Ensure user is logged in and session ID is available
...
// Fetch user data (not directly used in this script but kept for reference)
            ...
            <body>
                <script>
                    Swal.fire({
                        ...
                        window.location.href = 'change_password.php?edit_user=$user_id';
                    });
                </script>
            </body>
            </html>";
...
<body>
    <form action="verify_password.php" method="POST" class="container">
        ...
        <div class="back-link">
            <button type="button" onclick="window.location.href='edit_profile.php';">Go Back to Edit Profile</button>
        </div>
    </form>
