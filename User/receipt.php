...
$pdf->Cell(95, 6, 'Receipt #', 0, 0, 'C');
$pdf->Cell(95, 6, 'Order Date:', 0, 1, 'C');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(95, 6, 'MY-' . str_pad($order['order_id'], 3, '0', STR_PAD_LEFT), 0, 0, 'C');
$pdf->Cell(95, 6, date('Y-m-d', strtotime($order['order_date'])), 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->MultiCell(0, 6, "Thank you for your purchase!\nWe appreciate your business and hope you enjoy your products.\nFor any inquiries, please contact our support team.", 0, 'C');
